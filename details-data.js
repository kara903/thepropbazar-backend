...
const PROPERTY_DATA = {
    ...
    "Mantra Happy Homes": {
        ...
        society: {
            ...
            connectivity: [
                ...
                { icon: "fa-road", title: "NH- 58 Highway", distance: "3 Min Drive" },
                { icon: "fa-hospital", title: "Hospital", distance: "2 Min Drive" },
                { icon: "fa-cart-shopping", title: "Mall", distance: "2 Min Drive" },
                { icon: "fa-school", title: "School / College", distance: "3 Min Drive" },
                { icon: "fa-city", title: "Shivalik nagar", distance: "5 Min Drive" },
    ...
    "Deep Ganga": {
        ...
        society: {
            ...
            connectivity: [
                ...
                { icon: "fa-school", title: "School / College", distance: "3 Min Drive" },
                { icon: "fa-city", title: "Shivalik nagar", distance: "3 Min Drive" },
                { icon: "fa-gas-pump", title: "Petrol pump", distance: "1 Min Drive" },
                { icon: "fa-plane", title: "Jolly grand airport", distance: "45 Min Drive" },
                { icon: "fa-location-dot", title: "Dehradun", distance: "55 Min Drive" }
            ],
    ...
    "Jurs Country": {
        ...
        society: {
            ...
            connectivity: [
                { icon: "fa-place-of-worship", title: "Har Ki Pauri", distance: "12 Min Drive" },
                { icon: "fa-train", title: "Haridwar bus/railway station", distance: "10 Min Drive" },
                { icon: "fa-road", title: "NH- 58 Highway", distance: "On Highway (0 Min)" },
                { icon: "fa-hospital", title: "Hospital", distance: "2 Min Drive" },
                { icon: "fa-cart-shopping", title: "Mall", distance: "4 Min Drive" },
                { icon: "fa-school", title: "School / College", distance: "Inside Campus (Wisdom Global)" },
                { icon: "fa-city", title: "Shivalik nagar", distance: "4 Min Drive" },
                { icon: "fa-gas-pump", title: "Petrol pump", distance: "Next Door (1 Min)" },
                { icon: "fa-plane", title: "Jolly grand airport", distance: "35 Min Drive" },
                { icon: "fa-location-dot", title: "Dehradun", distance: "50 Min Drive" }
            ],
            strengths: [
    ...
    "Homeland": {
        ...
        society: {
            ...
            videos: [],
            connectivity: [
                { icon: "fa-train", title: "Railway Station", distance: "10 Min Drive" },
                { icon: "fa-road", title: "Main Road", distance: "1 Min Drive" },
                { icon: "fa-hospital", title: "Hospital", distance: "3 Min Drive" },
                { icon: "fa-school", title: "Schools", distance: "3 Min Drive" }
            ],
            strengths: [
